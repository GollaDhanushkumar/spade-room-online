...
export const FRIEND_AVATARS = [
  ...
  { id: 'friend:hari', name: 'Hari', file: '/avatars/friends/hari.jpeg' },
  {
    ...
    secretFlipFile: '/avatars/friends/bhavana-secret.png',
  },
  {
    id: 'friend:sindhu',
    name: 'Sindhu',
    file: '/avatars/friends/sindhu.jpeg',
    secretFlipFile: '/avatars/friends/sindhu-secret-v2.png',
  },
...
// 8 avataaars + 8 lorelei = 16 total
...
// Secrets are included here so getAvatarById works when other players see them.
